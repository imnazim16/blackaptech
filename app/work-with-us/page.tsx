        ...
        <div className={"wrapper py-25"}>
            <div className={"text-center"}>
                <h2 className={"text-6xl font-bold leading-[4rem] pb-4"}>
                    Our success is driven by the <br/>team’s skill and passion.
                </h2>
                <p className={"pb-20"}>
                    A heritage built on hard work and a focus on simply doing the right thing.
                </p>
            </div>
            <div className={"pb-20"}>
                <Image className={"object-cover h-[600px] w-full rounded-2xl"} src={"/people-with-laptops-office.jpg"} alt={"work with us"} width={256} height={256} />
            </div>
            <div className="grid grid-cols-2 gap-10 pb-20">
                <h2 className={"text-4xl font-semibold"}>
                    A forward-thinking interior <br/>fit-out & joinery company <br/>with a committed and <br/>passionate team.
                </h2>
                <div>
                    <p className={"pb-6"}>We believe in creating exceptional spaces, and that starts with an exceptional team.
                        We are always on the lookout for talented individuals who are passionate about craftsmanship,
                        innovation and delivering outstanding results.
                    </p>
                    <p className={"pb-6"}>Whether you're an experienced professional or just starting your career in
                        joinery manufacturing and fit-out, we offer opportunities to grow, develop, and make a real impact.
                    </p>
                </div>
            </div>
            ...
            <div className={"bg-gray-50 py-20 px-20 text-black rounded-3xl"}>
                <div className={"grid grid-cols-2 gap-10 pb-20"}>
                    ...
                    <div>
                        ...
                        <Link
                            className={"rounded-4xl px-6 pt-2 pb-3 inline-block mt-4 transition-all duration-300 bg-gray-600 text-white hover:bg-gray-950"}
